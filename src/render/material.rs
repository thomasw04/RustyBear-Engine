...
impl Material {
    ...
    pub fn new(context: &Context, textures: Vec<&wgpu::TextureView>, sampler: &wgpu::Sampler, name: &str) -> Material
    {
        ...
        Material { name: String::from(name), texture_count, bind_group, layout }
    }
